...
<div class="container">
    ...
    <form action="{{url('added')}}" method="post">
        ...
        <input type="text" name="emp_user_name">
        ...
        <select name="dep_name" class="dropdown">
        ...
        <select name="emp_type_id" class="dropdown">
        ...
        <select name="location_name" class="dropdown">
        ...
        <select name="shift_name" class="dropdown">
        ...
        <select name="shift_time_in" class="dropdown">
        ...
        <select name="shift_time_out" class="dropdown">
        ...
        <select name="emp_gender" class="dropdown">
